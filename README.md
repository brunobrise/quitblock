...
Simply use your usual quit shortcut (`Cmd+Q` on Mac / `Alt+F4` on Windows if configured) or run the command **"QuitBlock: Quit"** from the Command Palette (`Cmd+Shift+P`).
